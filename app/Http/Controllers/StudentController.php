...
class StudentController extends Controller
{
    ...
    public function create(Request $request) {
        ...
        $message = "Dear <br/>".$student->name."<br/>Welcome to Edexcel! 🎉 We’re excited to support you on your educational journey with top-notch resources and interactive learning.<br/>
