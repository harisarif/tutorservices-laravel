                                ...
                                <div class="col-xl-3 col-sm-6 col-12 my-3">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="media d-flex " style=" justify-content: space-between;">
                                            ...
                                            <div class="align-self-center animated-icons">
                                            <i class="fa-solid fa-globe data-insight-globe" aria-hidden="true" style="font-size: 25px;"></i>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.tutors && response.tutors.length > 0) {
                    ...
                    $('.tutors-range').text(`${firstItem} to ${lastItem} of ${totalTutors} tutors`);
            ...
            error: function (xhr) {
                console.error('AJAX Error:', xhr.responseText);
                $('#overlay').hide();
                $('#tutorsContainer').html('<p class="text-danger">An error occurred. Please try again.</p>');
            }
        });
    });
});
