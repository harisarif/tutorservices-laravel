...
<meta name="description"
    content="Hired tutor Eduexceledu offers a range of online courses and tutoring services to enhance your learning experience.">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown-container ms-2">
                            ...
                            <div class="dropdown-menu-box" style="display:none;">
                                <ul>
                                    <li>
                                        <a href="{{ route('front-edit-teacher', $tutor->id) }}"
                                            class="btn text-justify">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 border p-2 rounded">
                            ...
                            <p class="m-0 pt-1 tutors-range">
                                ...
                                0 of 0 tutors
                                @else
                                {{ $paginatedStudents->firstItem() }} to {{ $paginatedStudents->lastItem() }} of
                                {{ $paginatedStudents->total() }} tutors
                                @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <p class="mb-1"><strong>Contact Email:</strong>
                                                {{ $student->email ?? 'N/A' }}</p>
                                            <p class="mb-1"><strong>Subject:</strong> {{ $student->subject ?? 'N/A' }}
                                            </p>
                                        ...
                                        <div class="col-md-3">
                                            <p class="mb-1"><strong>Gender:</strong>
                                                {{ Str::ucfirst($student->gender ?? 'N/A') }}</p>
                                            <p class="mb-1"><strong>Country:</strong>
                                                {{ $student->country_name ?? 'N/A' }}</p>
                                            <p class="mb-1"><strong>City:</strong> {{ $student->city ?? 'N/A' }}</p>
                                            <p class="mb-1"><strong>Teach By:</strong>
                                                {{ $student->availability_status ?? 'N/A' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response && response.students && response.students.length > 0) {
                        ...
                        $('.total-tutors-count').text(total);
                        $('.tutors-range').text(
                            `${firstItem} to ${lastItem} of ${total} students`);
