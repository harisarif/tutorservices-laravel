...
<body>
   ...
   data-bs-toggle="dropdown" aria-expanded="false" style="padding: 0;">
                    ...
                    <div class="email-container me-1 d-flex align-items-center">
                        ...
                        <div class="dropdown-container ms-1">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#resetFilter').on('click', function() {
                ...
                console.log("🔄 Resetting filters to default: Male & United Arab Emirates");
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("fetch-stduent-data") }}', // Adjust if you use a different route
                    data: filterData,
                    dataType: 'json',
                    success: function(response) {
                        $('#overlay').hide();
                        ...
                        <div class="mb-4">
                            <div class="p-4 border border-success rounded">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="${student.profileImage ? '/storage/' + student.profileImage : '/images/avatar.png'}" class="img-thumbnail" style="height: 150px; width: 100%">
                                    </div>
                                    <div class="col-md-5">
                                        <p><strong>Name:</strong> ${student.name ?? 'N/A'}</p>
                                        <p><strong>Email:</strong> ${student.email ?? 'N/A'}</p>
                                        <p><strong>Subject:</strong> ${student.subject ?? 'N/A'}</p>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <p><strong>Teach By:</strong> ${student.availability_status ?? 'N/A'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>`;
