                                ...
                                <div class="row" style="margin-top: 100px;">
                                    <div class="col-md-6">
                                        <div class="d-flex pb-3 justify-content-between" style="border-bottom: 1px solid #b7b2b2;">
                                            ...
                                            <p class="mb-0" style="color: #198754;">{{ $notification->data['name'] }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex pb-3 justify-content-between" style="border-bottom: 1px solid #b7b2b2;">
                                            <h6 class="mb-0" style="color: #198754;">Email</h6>
                                            <p class="mb-0" style="color: #198754;">{{ $notification->data['email'] }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-md-4">
                                    <div class="col-md-6">
                                        <div class="d-flex pb-3 justify-content-between" style="border-bottom: 1px solid #b7b2b2;">
                                            ...
                                            <p class="mb-0" style="color: #198754;">{{ $notification->data['phone'] }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex pb-3 justify-content-between" style="border-bottom: 1px solid #b7b2b2;">
                                            <h6 class="mb-0" style="color: #198754;">Message</h6>
                                            <p class="mb-0" style="color: #198754;">{{ $notification->data['message'] }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="{{ route('admin.notifications') }}" class="btn btn-success mb-5">Back To Dashboard</a>
                    </div>
